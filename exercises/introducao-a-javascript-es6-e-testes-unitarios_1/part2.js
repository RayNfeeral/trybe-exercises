...
// JavaScript;
// HTML; ... #goTrybe".
const skills = ['Javascript', 'CSS', 'HTML', 'React', 'Node'];
const stringFormat = (string) => `Tryber ${string} aqui!`;
const skillsString = (string) => `${string} Minhas cinco principais habilidades são:
${skills.sort().join('\n')}`;

console.log(skillsString(stringFormat('Rafael')));
