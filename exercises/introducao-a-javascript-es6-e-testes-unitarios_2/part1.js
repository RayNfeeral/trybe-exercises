...
const orderModifier = (order) => {
  ...
  console.log(`Olá ${order.name}, o total do seu pedido de ${Object.keys(order.order.pizza).join(', ')} e ${Object.values(order.order.drinks).map(drink => drink.type).join(', ')} é R$ ${order.payment.total},00.`);
